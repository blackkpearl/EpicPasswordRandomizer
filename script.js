...
function generatePassword() {
  ...
  var lowerCaseletters = confirm("Would you like to include lowercase letter?");
  if (lowerCaseletters) {
  ...
  var specialCharletters = confirm("Would you like to include special characters?");
  if (specialCharletters) {
